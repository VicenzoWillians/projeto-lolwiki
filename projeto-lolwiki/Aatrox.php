                ...
                <section>
                    <div id="myCarousel" class="carousel slide champion-page-slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                    <img src="images/champions/aatrox/aatrox-splash.jpg" width="100%" height="100%" class="rounded mx-auto d-block w-100" alt="Não foi possível carregar a imagem.">
                                <div class="container">
                                    <div class="carousel-caption">
                                        <h1 class="h1-title">Aatrox</h1>
                                        <h3>A Espada Darkin</h3>
                                    </div>
                                </div>
                    ...
                    <div class="container content champion-page-content">
                        <div class="row" style="margin-bottom: 2rem">
                            <div class="col-6 champion-page-section">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                            $table = "SELECT * FROM estatisticas_base WHERE nome_campeao='Aatrox'";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6" style="text-align: center;">
                                        <?php
                                            $info = "SELECT * FROM campeao WHERE nome_campeao='Aatrox'";
                            ...
                            <div class="col-6">
                                ...
                                <p class="lead" style="text-align: justify;">
                                    <?php
                                        $historia = "SELECT historia_campeao FROM campeao WHERE nome_campeao='Aatrox'";
                                ...
                                <div class="row"  style="text-align: center;">
                                    <div class="col-4">
                                        <?php
                                            $detalhes = "SELECT rota_sugerida FROM campeao WHERE nome_campeao='Aatrox'";
                                    ...
                                    <div class="col-4">
                                        <?php
                                            $detalhes = "SELECT funcao_campeao_A FROM campeao WHERE nome_campeao='Aatrox'";
                                            $query=mysqli_query($con, $detalhes);
                                    ...
                                    <div class="col-4">
                                    <?php
                                            $detalhes = "SELECT dificuldade_campeao FROM campeao WHERE nome_campeao='Aatrox'";
                                            $query=mysqli_query($con, $detalhes);
                        ...
                        <div class="d-flex justify-content-center" id="more-info">
                            <p><a href="https://br.op.gg/champion/aatrox/statistics/top">op.gg</a></p>
                            <p><a href="https://www.leagueofgraphs.com/pt/champions/builds/aatrox">leagueofgraphs.com</a></p>
                            <p><a href="https://www.probuilds.net/champions/details/aatrox">probuilds.net</a></p>
                        </div>
                        <hr>
                        <div class="justify-content-center">
                            ...
                            <div class="content-habilidades">
                                <div class="habilidades-video">
                                    <iframe width="1102" height="620" src="https://www.youtube.com/embed/soQ9bukwAPs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="row skin-content">
                                        <div class="col-12">
                                            <button active onclick="skin('aatrox/aatrox-splash')">
                                                    <img src="images/champions/aatrox/aatrox_circle_skin.png" width="50px">
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('aatrox/justiceiro')">
                                                <img src="images/champions/aatrox/aatrox_circle_skin_2.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Aatrox Justiceiro
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('aatrox/mech')">
                                                <img src="images/champions/aatrox/aatrox_circle_skin_3.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Mech Aatrox
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('aatrox/mares')">
                                                <img src="images/champions/aatrox/aatrox_circle_skin_4.png" width="50px">
                                                <div class="margin-skin-text">
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('aatrox/lua')">
                                                <img src="images/champions/aatrox/aatrox_circle_skin_5.png" width="50px">
                                                <div class="margin-skin-text">
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('aatrox/lua-prestigio')">
                                                <img src="images/champions/aatrox/aatrox_circle_skin_6.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Aatrox Lua Sangrenta Edição de Prestígio
                                                </div>
                                            </button>
                                        </div>
                                        <div class="col-12">
                                            <button onclick="skin('aatrox/vitorioso')">
                                                <img src="images/champions/aatrox/aatrox_circle_skin_7.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Aatrox Vitorioso
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('aatrox/odisseia')">
                                                <img src="images/champions/aatrox/aatrox_circle_skin_8.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Aatrox Odisseia
                                                </div>
                                            </button>
                                ...
                                <div class="col-9 mySkin">
                                    <img id="mySkin" src="images/champions/aatrox/aatrox-splash.jpg" height="527px" width="950px">
                                </div>
                            </div>
                        </div>
                    </div>
