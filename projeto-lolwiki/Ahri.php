                ...
                <section>
                    <div id="myCarousel" class="carousel slide champion-page-slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                    <img src="images/champions/ahri/ahri-splash.jpg" width="100%" height="100%" class="rounded mx-auto d-block w-100" alt="Não foi possível carregar a imagem.">
                                <div class="container">
                                    <div class="carousel-caption">
                                        <h1 class="h1-title">Ahri</h1>
                                        <h3>A Raposa de Nove Caudas</h3>
                                    </div>
                                </div>
                    ...
                    <div class="container content champion-page-content">
                        <div class="row" style="margin-bottom: 2rem">
                            <div class="col-6 champion-page-section">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                            $table = "SELECT * FROM estatisticas_base WHERE nome_campeao='Ahri'";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6" style="text-align: center;">
                                        <?php
                                            $info = "SELECT * FROM campeao WHERE nome_campeao='Ahri'";
                                            ...
                                            if($info){
                                                if(mysqli_num_rows($query)>0){
                                                    while(($resultado=mysqli_fetch_assoc($query))!=null){
                                                        ...
                                                        if(utf8_encode($resultado['tipo_alcance'])=="Corpo a Corpo"){
                                                            echo '<img src="images/stats/melee_icon.png"> ';
                                                        } else{
                                                            echo ' <img src="images/stats/ranged_icon.png"> ';
                                                        }
                                                            
                                                        echo '' . utf8_encode($resultado['tipo_alcance']) . '</h6>
                            ...
                            <div class="col-6">
                                ...
                                <p class="lead" style="text-align: justify;">
                                    <?php
                                        $historia = "SELECT historia_campeao FROM campeao WHERE nome_campeao='Ahri'";
                                ...
                                <div class="row"  style="text-align: center;">
                                    <div class="col-4">
                                        <?php
                                            $detalhes = "SELECT rota_sugerida FROM campeao WHERE nome_campeao='Ahri'";
                                    ...
                                    <div class="col-4">
                                        <?php
                                            $detalhes = "SELECT funcao_campeao_A FROM campeao WHERE nome_campeao='Ahri'";
                                            $query=mysqli_query($con, $detalhes);
                                    ...
                                    <div class="col-4">
                                    <?php
                                            $detalhes = "SELECT dificuldade_campeao FROM campeao WHERE nome_campeao='Ahri'";
                                            $query=mysqli_query($con, $detalhes);
                        ...
                        <div class="d-flex justify-content-center" id="more-info">
                            <p><a href="https://br.op.gg/champion/ahri/statistics/mid">op.gg</a></p>
                            <p><a href="https://www.leagueofgraphs.com/pt/champions/builds/ahri">leagueofgraphs.com</a></p>
                            <p><a href="https://www.probuilds.net/champions/details/ahri">probuilds.net</a></p>
                        </div>
                        <hr>
                        <div class="justify-content-center">
                            ...
                            <div class="content-habilidades">
                                <div class="habilidades-video">
                                    <iframe width="1102" height="620" src="https://www.youtube.com/embed/aRInlkcte7Q" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="row skin-content">
                                        <div class="col-12">
                                            <button active onclick="skin('ahri/ahri-splash')">
                                                <img src="images/champions/ahri/ahri_circle_skin.png" width="50px">
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/dinastia')">
                                                <img src="images/champions/ahri/ahri_circle_skin_2.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri da Dinastia
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/noturna')">
                                                <img src="images/champions/ahri/ahri_circle_skin_3.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri Noturna
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/raposa')">
                                                <img src="images/champions/ahri/ahri_circle_skin_4.png" width="50px">
                                                <div class="margin-skin-text">
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/popstar')">
                                                <img src="images/champions/ahri/ahri_circle_skin_5.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri Estrela do Pop
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/desafiante')">
                                                <img src="images/champions/ahri/ahri_circle_skin_6.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri Desafiante
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/colegial')">
                                                <img src="images/champions/ahri/ahri_circle_skin_7.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri Colegial
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/fliperama')">
                                                <img src="images/champions/ahri/ahri_circle_skin_8.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri Fliperama
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/star')">
                                                <img src="images/champions/ahri/ahri_circle_skin_9.png" width="50px">
                                                <div class="margin-skin-text">
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/kda')">
                                                <img src="images/champions/ahri/ahri_circle_skin_10.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri K/DA
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/kda-prestigio')">
                                                <img src="images/champions/ahri/ahri_circle_skin_11.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri K/DA Edição de Prestígio
                                                </div>
                                            </button>
                                        </div>
                                        <div class="col-12">
                                            <button onclick="skin('ahri/sabugueiro')">
                                                <img src="images/champions/ahri/ahri_circle_skin_12.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri Sabugueiro
                                                </div>
                                            </button>
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/florescer')">
                                                <img src="images/champions/ahri/ahri_circle_skin_13.png" width="50px">
                                                <div class="margin-skin-text">
                                        ...
                                        <div class="col-12">
                                            <button onclick="skin('ahri/kda-all-out')">
                                                <img src="images/champions/ahri/ahri_circle_skin_14.png" width="50px">
                                                <div class="margin-skin-text">
                                                    Ahri K/DA All Out
                                                </div>
                                            </button>
                                ...
                                <div class="col-9 mySkin">
                                    <img id="mySkin" src="images/champions/ahri/ahri-splash.jpg" height="527px" width="950px">
                                </div>
                            </div>
                        </div>
                    </div>
